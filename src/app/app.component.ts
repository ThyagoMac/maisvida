...
export class MyApp {
  ...
  constructor(public platform: Platform, public statusBar: StatusBar, public splashScreen: SplashScreen) {
    ...
    this.pages = [
      { title: 'Tela de Login', component: HomePage },
      { title: 'Lista de Médicos', component: ListarMedicosPage },
      { title: 'Cadastro', component: CadastrarMedicosPage }
      //{ title: 'Visualizar', component: VisualisarMedicosPage }
